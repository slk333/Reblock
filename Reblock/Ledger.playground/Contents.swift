...
// an adress has an id and can be targetted by transactions
// the balance of an address is the total received from transactions that targetted this address
...
// reading the balance by reading in the ledger the value of the transaction that outputs to this adress
myAddress.balance
